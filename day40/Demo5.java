...
//startsWith(), endsWith(), contains(),equalsIgnorecase,equals,comapareTo
public class Demo5 {
	public static void main(String[] args) {
		...
		System.out.println(url.contains("Akshara"));
		System.out.println(url.contains("grishma"));

		System.out.println(url.contains("Akshara".toLowerCase()));// comapares Akshara in lower case
